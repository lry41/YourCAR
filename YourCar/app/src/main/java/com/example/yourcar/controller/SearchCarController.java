...
public class SearchCarController extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Car car = new Car(" bmw", "x6", 2015,210,6000,45000,"https://freepngimg.com/thumb/bmw/58046-car-bmw-2015-2014-2016-x5.png");
        //database.child("bmw x6").setValue(car);
    ...
    private void setOnclikListner() {
        ...
        listener = new AdapterOffresCar.RecyclerViewClickListener() {
            ...
            public void OnClick(View v, int position) {
                ...
                Log.d("test","click");
                Intent visuVehicule = new Intent(SearchCarController.this,Appercu_vehiculeController.class);
